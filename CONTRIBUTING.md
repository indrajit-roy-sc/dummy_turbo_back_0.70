...
yarn test
```
To edit the Objective-C files, open `example/ios/DummyTurboBack070Example.xcworkspace` in XCode and find the source files at `Pods > Development Pods > react-native-dummy_turbo_back_0.70`.

To edit the Kotlin files, open `example/android` in Android studio and find the source files at `reactnativedummyturboback070` under `Android`.
